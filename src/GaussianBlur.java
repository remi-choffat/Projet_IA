...
/**
 * Classe pour appliquer un flou gaussien à une image.
...
public class GaussianBlur implements Blur {
    ...
    private final int[][][] filtres_gauss = {
            {
                    {1, 2, 1},
                    {2, 4, 2},
                    {1, 2, 1},
     ...
     *
     * @param img  l'image à flouter
     * @param size le rayon du flou (en pixels)
     * @return une nouvelle image floutée
     */
    public BufferedImage blur(BufferedImage img, int size) {
        ...
        // On choisit par combien sera divisée la moyenne
        int divide = 0;
        for (int[] ints : filtre) {
